...
def run_rf_1d_experiments():
    print("=== RF 1D EXPERIMENTOS (CV) ===")
    ...
    for param_name, values in rf_sweeps.items():
        ...
        _save_cv_results_csv(grid_search, suffix=param_name)
        print(f"✅ RF 1D procesado: {param_name}.")


if __name__ == "__main__":
    run_rf_1d_experiments()
